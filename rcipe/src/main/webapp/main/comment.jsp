...
<script type="text/javascript">
  window.viewReplyList = function(value) {
    ...
    $('#' + value + 'ReplyList').css('display', 'inline');
  }
  $(document)
      .ready(
          function() {
            ...
            function listBoardCmt(id, list) {
              ...
              for ( var i in list) {
                str += "<div id='comment"+i+"'><div class='row'>"
                    ...
                    + "</div>"
                    + "<hr /></div>"
                    + "<div id='"+list[i].commentNo+"ReplyList' class='replyList'>"
                    + "<div class='row'>"
                    ...
                    + "   <div class='col-md-10'>"
                    + "<input type='hidden' id='contentNo' value='"+list[i].commentNo+"'>"
        ...
        <div class="row">
          ...
          <div class="col-md-11">
            <div>
              <div class="row">
                <div class="col-md-7" align="left">
                  <div style="margin-left: 2%; margin-right: 2%;">${comment.nickname }/
...
onclick="removeComment('${comment.commentNo}')">삭제</a> --%>
                    <%-- </c:if> --%>
                  </div>
                </div>
              </div>
      ...
      <hr />
      <div id="${comment.commentNo}ReplyList" class="replyList">
        <div class="row">
          <div class="col-md-1" align="center">
            <span class="glyphicon glyphicon-arrow-right"
