...
<script>
	$("document").ready(function() {
		...
		$('#getViewBoardButton').click(function() {
			$(location).attr('href', "../board/getInsertBoard");
		});
	});
	...
	window.funcTab = function(category) {
		...
		alert('category : ' + category + ' selectListNum : ' + selectListNum
				+ ' params : ' + params + ' currentCategory : '
				+ currentCategory + ' flag : ' + flag);
				...
				<div class="panel-heading">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#" onClick="funcTab(0);" id="0"
							>레시피</a></li>
						<li><a href="#" onClick="funcTab(1);" 
							id="1">추천맛집</a></li>
						<li><a href="#" onClick="funcTab(2);"
							id="2">고민상담</a></li>
						<li><a href="#" onClick="funcTab(3);" 
							id="3">기타</a></li>
