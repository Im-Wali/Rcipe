...
<script type="text/javascript"
	src="${pageContext.servletContext.contextPath }/js/bootstrap-filestyle.js"></script>
						...
						<div class="media">
							...
							<div>
								<textarea class="form-control" readonly="readonly" rows="3"
									style="background-color: white" placeholder="재료를 입력하세요"
									id="ingredients" name="ingredients">${recipe.ingredients}</textarea>
							</div>
							<div style="margin: 1%">
							...
							<div>
								<textarea class="form-control" rows="10"
									placeholder="간단한 설명을 적어주세요" name="recipeContents">${recipe.recipeContents }</textarea>
							</div>
							<div style="margin: 1%">
								<label style="color: red; font-size: x-large;">*Tip</label>
							</div>
							<div>
								<textarea class="form-control" rows="3" placeholder="Tip을 적어주세요"
									id="tip" name="tip">${recipe.tip }</textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<c:forEach var="detail" items="${recipe.detailRecipe}">
					...
					<div class="form-login " style="margin-bottom: 2%;"
						...
						<button type="button" class="close recipeClose"
							data-dismiss="modal" aria-label="Close" value="detail${ i}">
							<span>&times;</span>
						</button>
						<h3 align="center" style="margin-bottm: 1%">상세 레시피 작성</h3>
						<div style="margin-top: 1%">
							<div class="media">
								...
								<div>
									<textarea class="form-control" rows="5"
										placeholder="사진에 대한 설명을 적어주세요" name="detailContents${i}">${detail.detailContents}</textarea>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="form-login " style="margin-bottom: 2%;" align="center">
					<div>
						<input type="button" class="btn   btn-lg addDetail"
							value="추가 사진 등록"
							style="margin-right: 1%; margin-bottom: 1%; width: 100%; height: 100%; background-color: #707070; color: white">
					</div>
					<div>
						<span style="color: red; margin-right: 1%">*추가적인 사진과 정보를
							입력하세요!</span>
