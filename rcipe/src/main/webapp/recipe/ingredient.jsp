	...
	$(document)
			.ready(
					function() {
						...
						$("#ingredientClose").click(function() {
					...
					<form id="searchIngredientForm" action="#">
						<span id="imaginary_container"> <span
							class="input-group stylish-input-group"> <input
								...
								id="ingredientKeyword"> <span class="input-group-addon">
				...
				<div align="right">
					<div>
						<a href="#" class="btn btn-info" data-toggle="modal"
							data-target="#insertIngredient" id="insertINgredientOpen"
							data-whatever="insertIngredient" data-backdrop="false">재료
							새로추가</a>
					</div>
					<div>
...
<div class="modal fade" id="insertIngredient" tabindex="-1"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div style="margin-top: 2%;">
					<form id="insertIngredient" action="#">
						<div class="input-group">
							<input type="text" class="form-control" id="ingredientAdmitText"
								placeholder="등록할 재료명을 입력하세요"> <span
								class="input-group-addon btn-primary"
								style="background-color: rgb(57, 179, 215); color: white"
								id="ingredientAdmitButton"><i
